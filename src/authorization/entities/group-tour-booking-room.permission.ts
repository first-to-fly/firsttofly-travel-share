export const GroupTourBookingRoomPermissions = {
  ...
  "dept:group-tour-booking-room:view": {
    ...
    description: "Can view Group Tour Booking Rooms within their department's scope (via a transaction)",
  },
  "dept:group-tour-booking-room:create": {
    name: "Create Department Group Tour Booking Room",
    description: "Can create Group Tour Booking Rooms within their department's scope (via a transaction)",
  },
  "dept:group-tour-booking-room:update": {
    name: "Update Department Group Tour Booking Room",
    description: "Can update Group Tour Booking Rooms within their department's scope (via a transaction)",
  },
  "dept:group-tour-booking-room:delete": {
    name: "Delete Department Group Tour Booking Room",
    description: "Can delete Group Tour Booking Rooms within their department's scope (via a transaction)",
  },
  ...
  "tenant:group-tour-booking-room:view": {
    ...
    description: "Can view all Group Tour Booking Rooms within the tenant (usually via a transaction)",
  },
  "tenant:group-tour-booking-room:create": {
    name: "Create Tenant Group Tour Booking Room",
    description: "Can create Group Tour Booking Rooms within the tenant (usually via a transaction)",
  },
  "tenant:group-tour-booking-room:update": {
    name: "Update Tenant Group Tour Booking Room",
    description: "Can update Group Tour Booking Rooms within the tenant (usually via a transaction)",
  },
  "tenant:group-tour-booking-room:delete": {
    name: "Delete Tenant Group Tour Booking Room",
    description: "Can delete Group Tour Booking Rooms within the tenant (usually via a transaction)",
  },
};
