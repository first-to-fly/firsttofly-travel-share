...
export enum DiscountValidationErrorCode {
  DISCOUNT_NOT_FOUND = "DISCOUNT_NOT_FOUND",
  DISCOUNT_INACTIVE = "DISCOUNT_INACTIVE",
  DISCOUNT_EXPIRED = "DISCOUNT_EXPIRED",
  INVALID_BOOKING_CHANNEL = "INVALID_BOOKING_CHANNEL",
  INVALID_TOUR_RESTRICTION = "INVALID_TOUR_RESTRICTION",
  INSUFFICIENT_SPENDING = "INSUFFICIENT_SPENDING",
  INSUFFICIENT_PASSENGERS = "INSUFFICIENT_PASSENGERS",
  INVALID_PASSENGER_TYPE = "INVALID_PASSENGER_TYPE",
  OUTSIDE_SPECIAL_DATES = "OUTSIDE_SPECIAL_DATES",
  OUTSIDE_TIMESLOT = "OUTSIDE_TIMESLOT",
